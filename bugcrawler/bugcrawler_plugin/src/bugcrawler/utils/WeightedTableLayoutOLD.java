 ...
 */
public class WeightedTableLayoutOLD extends TableLayout {
	private int[] weights;
	 ...
	 */
	public WeightedTableLayoutOLD(int[] weights) {
		this(weights, null);
	}
	 ...
	 */
	public WeightedTableLayoutOLD(int[] weights, int[] fixedWidths) {
		if (weights != null)
